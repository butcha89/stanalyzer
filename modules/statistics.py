...
try:
    from modules.cup_size_module import CupSizeModule
except ImportError as e:
    logging.error(f"Failed to import CupSizeModule: {e}")
    CupSizeModule = None

try:
    from modules.o_counter_module import OCounterModule
except ImportError as e:
...
try:
    from modules.sister_size_module import SisterSizeModule
except ImportError as e:
    logging.error(f"Failed to import SisterSizeModule: {e}")
    SisterSizeModule = None

try:
    from modules.preference_module import PreferenceModule
except ImportError as e:
